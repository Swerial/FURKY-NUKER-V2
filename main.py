# FURKY NUKER MADE BY TEAM FURKY
 ...
 ░ ░    ░░░ ░ ░   ░░   ░ ░ ░░ ░  ▒ ▒ ░░        ░   ░ ░  ░░░ ░ ░ ░ ░░ ░    ░     ░░   ░ 
          ░        ░     ░  ░    ░ ░                 ░    ░     ░  ░      ░  ░   ░     
                                 ░ ░                                                   
                                                            ...
                                                            {Fore.MAGENTA}FURKY NUKER
    ''')
    print(f'{Fore.BLUE}                      FURKY Nuker Version | {NUKER.__version__}')
...
async def role(ctx, choice):
    if choice == 'create':
        ...
        for i in range(1, 25):
            await ctx.guild.create_role(name=f'NUKED BY FURKY {i}')
    elif choice == 'delete':
        await ctx.message.delete()
...
async def channel(ctx, choice):
    if choice == 'create':
        ...
        for i in range(1, 25):
            await ctx.guild.create_text_channel(name=f'NUKED-BY-FURKY {i}')
            await ctx.guild.create_voice_channel(name=f'NUKED BY FURKY {i}')
            await ctx.guild.create_category(name=f'NUKED BY FURKY {i}')
    elif choice == 'delete':
        await ctx.message.delete()
